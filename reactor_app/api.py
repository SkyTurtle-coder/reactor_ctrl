...
def _control_command_to_dict(item: ControlCommand, *, include_events: bool = False) -> dict[str, Any]:
    payload = {
        ...
        "command_source": item.command_source,
        "command_priority": item.command_priority,
        ...
        "queue_timeout_s": item.queue_timeout_s,
        "execution_timeout_s": item.execution_timeout_s,
        "total_deadline_at": _dt(item.total_deadline_at),
        "cancel_requested_at": _dt(item.cancel_requested_at),
